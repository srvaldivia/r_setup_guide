...
subtitle: "Guía de instalación y configuración inicial"
author:
  name: "Sebastián Valdivia Ramírez"
  # degrees: "MSc"
  affiliation: "GEO3211-1 · Introducción a la Programación en Geografía"
date: "today"
...
Para instalar la última versión disponible de R ingrese al sitio web de CRAN (*The Comprehensive R Archive Network*) <https://cran.r-project.org/bin/windows/base/>. Una vez allí haga clic en `Download R-4.5.3 for Windows` para iniciar la descarga @fig-1.
...
Luego de finalizada la descarga abra el archivo `R-4.5.3-win.exe` para comenzar con el proceso de instalación. Siga las instrucciones que aparecen en las imágenes que se muestran a continuación.
...
Para descargar la última versión de RStudio ingrese al sitio web <https://posit.co/download/rstudio-desktop/> y haga clic en el botón `DOWNLOAD RSTUDIO DESKTOP FOR WINDOWS` (@Fig-11) . La versión compatible con sistemas operativos como MacOS o Linux se encuentra disponible para descarga en la sección `All Installers and Tarballs`.
...
-   ![](images/clipboard-789153373.png){width="25"} **Desactivar** la **casilla** “Restore most recently opened project at startup”.

-   ![](images/clipboard-523719349.png){width="25"}**Desactivar** la **casilla** “Restore previously open source document at startup”.

-   ![](images/clipboard-668667740.png){width="25"}**Desactivar** la **casilla** “Restore .RData into workspace at startup”.

-   ![](images/clipboard-2876350395.png){width="25"}**Escoger** la **opción** “Never” en la casilla “Save workspace to .RData on exit”.

-   ![](images/clipboard-3927690316.png){width="25"}**Desactivar** la **casilla** “Always save history (even when not saving.RData)”.

-   ![](images/clipboard-4197769193.png){width="25"}**Desactivar** la **casilla** “Automatically notify me of updates of RStudio”.

<br>

Diríjase a la sección `Code` y seleccione la pestaña `Editing` (@fig-17). Una vez ahí **active la casilla** “Use native pipe operator, \|\> (requires R 4.1+)”![](images/clipboard-1009864358.png){width="25"} .
...
-   ![](images/clipboard-1305851736.png){width="25"}**Activar** la **casilla** “Highlight selected word” **(7)**.

-   ![](images/clipboard-2506098949.png){width="25"}**Activar** la **casilla** “Show margin” **(8)**.

-   ![](images/clipboard-1147041735.png){width="25"}**Activar** la **casilla** “Allow scroll past end of document” **(9)**.

-   ![](images/clipboard-3282586791.png){width="25"}**Activar** la **opción** “Highlight R function calls” **(10)**.

-   ![](images/clipboard-670696571.png){width="25"}**Activar** la **casilla** “Rainbow parentheses” **(11)**.

Finalmente diríjase a la pestaña `Saving`, haga clic en el botón `Change…` y seleccione la opción `UTF-8` (@fig-19) ![](images/clipboard-308707322.png){width="25"}.

![Global Options \> Code \> Saving](img/19_rs.png){#fig-19 fig-align="center"}

Para guardar todos estos cambios haga clic en el botón `OK` en la ventana de `Global` `Options` ![](images/clipboard-3161868667.png){width="25"}.
