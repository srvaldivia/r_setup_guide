...
-   ![](images/n_1.png){width="25"} **Desactivar** la **casilla** “Restore most recently opened project at startup”.
...
-   ![](img/n_8.png){width="25"}**Activar** la **casilla** “Highlight selected word” **(7)**.

-   ![](img/n_9.png){width="25"}**Activar** la **casilla** “Show margin” **(8)**.

-   ![](img/n_10.png){width="25"}**Activar** la **casilla** “Allow scroll past end of document” **(9)**.

-   ![](img/n_11.png){width="25"}**Activar** la **opción** “Highlight R function calls” **(10)**.

-   ![](img/n_12.png){width="25"}**Activar** la **casilla** “Rainbow parentheses” **(11)**.
