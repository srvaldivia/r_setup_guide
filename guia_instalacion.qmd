...
En la barra superior de la ventana de RStudio (@fig-15) haga clic en `Tools`\> seleccione `Global Options` \> y luego sección `General` (@fig-16).

![Ventana principal de RStudio](img/16_rs.png){#fig-16 fig-align="center" width="692"}
...
![Ventana principal de RStudio](img/17_rs.png){#fig-17 fig-align="center" width="692"}

Diríjase a la pestaña `Saving`, haga clic en el botón `Change…`, y seleccione la opción `UTF-8`.

Para guardar estos cambios haga clic en el botón `OK` en la ventana de `Global` `Options`. Esto cerrará la ventana de `Global` `Options`volviendo a la ventana principal de RStudio.
